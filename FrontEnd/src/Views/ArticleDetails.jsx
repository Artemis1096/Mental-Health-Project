...
const ArticleDetails = () => {
  ...
  return (
    <>
      {isUpdate && (
        <div className="w-full h-full bg-white absolute flex flex-col justify-center items-center opacity-70">
          <h1 className="text-black">Updating this article</h1>
          <form
          ...
          >
            ...
            <button
              type="submit"
              className="!bg-purple-950 p-2 rounded-2xl text-white"
            >
              Update
            </button>
          </form>
